...
async function fetchCryptoNewsSentiment(projectName: string, ticker?: string) {
  try {
    ...
    // Filter to only articles actually about this project (prevents motor finance etc false matches)
    ...
    // Fall back to all articles if nothing matches (better than empty)
